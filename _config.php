<?php 
$conn = mysqli_connect("localhost", 'animehin_root' , 'Fazal@2002', "anikatsu") or die("Connection fail");
...
// API URL
$api = "https://apistate-7bb868d2c9c5.herokuapp.com"; // https://github.com/shashankktiwariii/anikatsu-api
